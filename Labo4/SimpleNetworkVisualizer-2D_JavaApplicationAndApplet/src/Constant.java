...
public class Constant {
	...
	public static final boolean USE_ALPHA_COMPOSITING = true;
	public static final boolean SUFFIX_NODE_LABELS_WITH_METADATA = false;
	public static final boolean IS_FORCE_DIRECTED_LAYOUT_ACTIVE_INITIALLY = false;
